...
public class PaginaUsuarioView extends JFrame {
    ...
    public PaginaUsuarioView(String nome, String dataNascimento, String genero, String email, String telefone,
        ...
        // Ações dos botões
        realizarSeguroButton.addActionListener(
                e -> JOptionPane.showMessageDialog(PaginaUsuarioView.this, "Abrir tela para realizar seguro."));
        verificarSeguroButton.addActionListener(
                e -> JOptionPane.showMessageDialog(PaginaUsuarioView.this, "Abrir tela para verificar seguro."));
        adicionarDependenteButton.addActionListener(
                e -> JOptionPane.showMessageDialog(PaginaUsuarioView.this, "Abrir tela para adicionar dependentes."));
    }
